...
| SafeTensors inspection | PASS | Valid descriptor, dtype/shape byte-size, file-bound, and overlap rejection fixtures | Shard manifest handling and descriptor-name/index API are still pending |

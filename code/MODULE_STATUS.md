...
| Vulkan packed-int8 DP4 dispatch | PASS | Real compute dispatch differentially returns expected result on llvmpipe; registry contract declares I8→I32 and 4-byte alignment | Native quantized model integration, benchmark, and discrete-GPU validation pending |

...
| Lazy/disk-backed residency | IN PROGRESS | Model handles bind validated data bases to range-checked relative tensor spans; GGUF descriptors can be queried without reading tensor payloads | Add SafeTensors descriptor queries, mmap/window adapters, prefetch, and residency traces |

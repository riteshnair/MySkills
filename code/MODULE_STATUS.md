...
| Lazy/disk-backed residency | IN PROGRESS | Read-only bounded `lm_file_open/read` plus range-checked `lm_file_span` are implemented and tested | Add mmap/window adapters, tensor descriptor spans, prefetch, and residency traces |
